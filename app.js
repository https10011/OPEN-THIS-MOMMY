document.addEventListener("DOMContentLoaded", async () => {
  ...
  const timeElapse = (date) => {
    ...
    const result = `Our Journey <span class="digit">${days}</span> Days <span class="digit">${hours}</span> Hours <span class="digit">${minutes}</span> Minutes <span class="digit">${seconds}</span> Seconds`;
